...
host_server = os.environ.get('host_server', 'akuvitpostgresql.postgres.database.azure.com')
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5432')))
database_name = os.environ.get('database_name', 'akuvitBD')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'akuvitpostgresql@akuvitpostgresql')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'Achrafkarboul123456')))
